...
with center_col:
    ...
    st.plotly_chart(fig1_b, use_container_width=True, key="ai_chart_1")
    st.plotly_chart(fig2_b, use_container_width=True, key="ai_chart_2")
...
with right_col:
    ...
    st.plotly_chart(fig1_h, use_container_width=True, key="hyb_chart_1")
    st.plotly_chart(fig2_h, use_container_width=True, key="hyb_chart_2")
